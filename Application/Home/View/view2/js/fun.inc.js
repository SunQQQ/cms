...
function navnow(dom,part2,part3,none){
	...
	var dl=li.next("https://www.metinfo.cn/demo/met101/361/templates/met101/images/js/dd.sub");
	if(none)dl.hide();
	if(part2.next("https://www.metinfo.cn/demo/met101/361/templates/met101/images/js/dd.sub").length>0)part2.next("https://www.metinfo.cn/demo/met101/361/templates/met101/images/js/dd.sub").show();
	if(part3.length>0)part3.parent('https://www.metinfo.cn/demo/met101/361/templates/met101/images/js/dd.sub').show();
	li.bind('click',function(){
		var fdl=$(this).next("https://www.metinfo.cn/demo/met101/361/templates/met101/images/js/dd.sub");
		if(fdl.length>0){
...
if($number==3){
	 $('.index1>div:eq(0)').css({width:"275px"});
	 $('.index1>div:eq(1)').css({width:"415px",marginLeft:"15px"});
	 $('.index1>div:eq(2)').css({width:"220px"}); 
}else if($number==2){
